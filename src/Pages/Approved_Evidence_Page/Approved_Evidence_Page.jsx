...
function Approved_Evidence_Page(){
    return(
        <>
            ...
            data={[
                { tên_hoạt_động: "Chiến dịch tình nguyện hè 2023", người_nộp: "Nguyễn Văn A", ngày_nộp: "25/08/2023", trạng_thái: "Chờ duyệt" },
                { tên_hoạt_động: "Hiến máu nhân đạo đợt 1", người_nộp: "Trần Thị B", ngày_nộp: "22/08/2023", trạng_thái: "Đã duyệt" },
                 { tên_hoạt_động: "Chiến dịch tình nguyện hè 2023", người_nộp: "Nguyễn Văn A", ngày_nộp: "25/08/2023", trạng_thái: "Chờ duyệt" },
                { tên_hoạt_động: "Hiến máu nhân đạo đợt 1", người_nộp: "Trần Thị B", ngày_nộp: "22/08/2023", trạng_thái: "Đã duyệt" },
                 { tên_hoạt_động: "Chiến dịch tình nguyện hè 2023", người_nộp: "Nguyễn Văn A", ngày_nộp: "25/08/2023", trạng_thái: "Chờ duyệt" },
                { tên_hoạt_động: "Hiến máu nhân đạo đợt 1", người_nộp: "Trần Thị B", ngày_nộp: "22/08/2023", trạng_thái: "Đã duyệt" },
